...
@click.command(name='pers-fed-learn',
...
@click.option(
    ...
    type=str,
    show_default=True,
    default='BasicPersonalizedDataManager',
...
@click.pass_context
def pers_fed_learn(ctx: click.core.Context, rounds: int, data_manager: str,
                   ...
                   seed: Optional[float], device: str, log_dir: str,
                   log_freq: int, verbosity: int) -> None:
